...
class BranchyResNet(nn.Module):
    ...
    """
    def __init__(self, num_classes: int, base_model: str = 'resnet18', yield_mode: bool = False):
        """
    ...
    def forward(self, x: torch.Tensor) -> Union[Generator[torch.Tensor, None, None], torch.Tensor]:
        """
